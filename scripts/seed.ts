...
async function main() {
    ...
    await client.createOrReplace({
        ...
        navigation: [
            { _key: 'nav-products', _type: 'navItem', title: 'Products', path: '/products', position: 'left' },
            { _key: 'nav-collections', _type: 'navItem', title: 'Explore Collections', path: '/collections', position: 'left' },
            { _key: 'nav-on-sale', _type: 'navItem', title: 'On Sale', path: '/products?on_sale=true', position: 'left' },
            { _key: 'nav-best-value', _type: 'navItem', title: 'Best Value', path: '/collections', position: 'left' },
            { _key: 'nav-commercial', _type: 'navItem', title: 'Commercial', path: '/commercial', position: 'left' },
            { _key: 'nav-service', _type: 'navItem', title: 'Service', path: '/services', position: 'left' },
            { _key: 'nav-trades', _type: 'navItem', title: 'Trades', path: '/trades', position: 'left' },
            { _key: 'nav-instant-discount', _type: 'navItem', title: 'Instant Discount', path: '/contact', position: 'left' },
        ],
        contactInfo: {
    ...
    await client.createOrReplace({
        ...
        hero: {
            ...
            categories: [
                { _key: 'hc-1', label: 'Hardwoods', link: '/collections/hardwood' },
                { _key: 'hc-2', label: 'Engineered', link: '/collections/engineered-hardwood' },
                { _key: 'hc-3', label: 'Laminates', link: '/collections/laminate' },
                { _key: 'hc-4', label: 'Vinyl', link: '/collections/luxury-vinyl-plank' },
                { _key: 'hc-5', label: 'Mats', link: '/accessories' },
            ],
        },
        choosingSection: {
        ...
        whatWeOffer: {
            ...
            items: [
                { _key: 'wwo-1', title: 'Hardwood', description: 'Bring timeless elegance into your home with authentic natural wood floors built to last for generations.' },
                { _key: 'wwo-2', title: 'Engineered', description: 'Enjoy the beauty of real hardwood with added stability, making it ideal for modern homes and changing climates.' },
                { _key: 'wwo-3', title: 'Vinyl', description: 'A stylish, waterproof flooring option that stands up to busy families, pets, and everyday life with ease.' },
                { _key: 'wwo-4', title: 'Laminate', description: 'Get the look of hardwood at a budget friendly price, with durable performance made for high traffic spaces.' },
                { _key: 'wwo-5', title: 'Custom Floors', description: 'Create a one of a kind floor designed around your style, your space, and your exact project needs.' },
                { _key: 'wwo-6', title: 'Unfinished', description: 'Start with raw wood and customize the stain, tone, and finish to match your home perfectly.' },
                { _key: 'wwo-7', title: 'Adhesive', description: 'Professional installation starts here — high quality adhesives that ensure strong, long lasting results.' },
                { _key: 'wwo-8', title: 'Accessories', description: 'From trims to underlayment, find the essential finishing touches that make your flooring project complete.' },
                { _key: 'wwo-9', title: 'Coatings', description: 'Protect your investment with premium coatings that enhance durability, shine, and long term beauty.' },
                { _key: 'wwo-10', title: 'Lumber', description: 'Reliable, high quality lumber for flooring, construction, and custom woodworking projects.' },
                { _key: 'wwo-11', title: 'Home Decor', description: 'Elevate your space with carefully selected decor elements that pair beautifully with your flooring.' },
                { _key: 'wwo-12', title: 'Commercial', description: 'Durable flooring solutions designed to handle heavy traffic while maintaining a clean, professional look.' },
            ],
        },
        ourSpecialty: {
            intro: 'Everything you need from first visit to finished floor.',
            items: [
                { _key: 'os-1', number: '01', title: 'Supply', description: 'Hardwoodliving offers a variety of hardwood and engineered flooring, with more wood, tile, vinyl, and remodeling products coming soon.' },
                { _key: 'os-2', number: '02', title: 'Installation', description: 'Floor installation is key to long lasting results. We provide expert, unbiased guidance to ensure a smooth, reliable, and beautiful finish.' },
                { _key: 'os-3', number: '03', title: 'Contracting', description: 'Expert installation recommendations and coordination with trusted professionals.' },
                { _key: 'os-4', number: '04', title: 'Maintenance', description: 'Tips and products to keep your floors looking pristine for years to come.' },
            ],
            ctaText: 'Book a showroom visit',
            ctaLink: '/contact',
        },
        flooringGrades: {
            ...
            grades: [
                { _key: 'fg-1', name: 'Prime /AB', bullets: ['High-end grade', 'Even appearance', 'Few or no knots', 'Low sap wood', 'Center cut'] },
                { _key: 'fg-2', name: 'Select /ABc', bullets: ['Select / & better', 'Small knots 5-10%', 'Color variations', 'Milling imperfect', 'Smooth, flat cut'] },
                { _key: 'fg-3', name: 'Natural /ABcd', bullets: ['More character', 'More, larger knots', 'Sap wood, variety', 'Spots, streaks', 'Knot holes, splits'] },
                { _key: 'fg-4', name: 'Rustic / Cd', bullets: ['Character', 'Knots, raw texture', 'Imperfections', 'Stains, split ends', 'Shattered pieces'] },
            ],
        },
        lumberCuts: {
            heading: 'Lumber cuts',
            ...
            cuts: [
                { _key: 'lc-1', name: 'Plainsawn', description: 'Wood cut parallel to the growth rings (0°–45°) is called plainsawn in hardwoods and flatsawn in softwoods. It is stable in thickness but less stable in width.' },
                { _key: 'lc-2', name: 'Riftsawn', description: 'Here\'s a shorter version of that text: Riftsawn (hardwoods) or bastard sawn (softwoods) lumber is cut so the growth rings form 30°–60° angles to the board\'s face.' },
                { _key: 'lc-3', name: 'Quartersawn', description: 'Quartersawn (hardwoods) or vertical grain (softwoods) lumber is cut perpendicular to the growth rings (45°–90°). It\'s more stable in width but less stable in thickness.' },
                { _key: 'lc-4', name: 'Livesawn', description: 'Live sawn wood is cut straight from log to board, showing the full range of grain patterns, width, and stability.' },
            ],
        },
        limitedTimeOffer: {
        ...
        whyLoveUs: {
            ...
            items: [
                { _key: 'wlu-1', title: 'Premium Materials', description: 'We source only the highest quality flooring from trusted European and local brands.' },
                { _key: 'wlu-2', title: 'Expert Guidance', description: 'Our flooring specialists help you pick the perfect match for your lifestyle and taste..' },
                { _key: 'wlu-3', title: 'Seamless Experience', description: 'From selection to installation, we make the entire process effortless and enjoyable.' },
                { _key: 'wlu-4', title: 'Built to Last for Real Life', description: 'Durable design that keeps up with your everyday.' },
            ],
        },
        ...
        faq: {
            ...
            items: [
                { _key: 'faq-1', question: 'Do I need an appointment to visit the showroom?', answer: 'Walk ins are welcome, but we recommend booking an appointment so a specialist can be ready to assist you personally.' },
                { _key: 'faq-2', question: 'Can I take samples home?', answer: '' },
                { _key: 'faq-3', question: 'Where is the showroom located?', answer: '' },
                { _key: 'faq-4', question: 'Do you offer installation services?', answer: '' },
                { _key: 'faq-5', question: 'What are your payment options?', answer: '' },
            ],
        },
