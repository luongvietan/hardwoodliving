...
vi.mock("@/lib/sanity/queries", () => ({
  ...
  getAllPagesForPathResolutionQuery: 'mock-all-pages-for-path-resolution-query',
  getPageByIdQuery: 'mock-page-by-id-query',
  getAllCategoriesQuery: 'mock-all-categories-query',
  getAllCategoriesWithParentQuery: 'mock-all-categories-with-parent-query',
  ...
  getVisibleProductsByCategoryAndDescendantsQuery: 'mock-visible-products-by-category-descendants-query',
