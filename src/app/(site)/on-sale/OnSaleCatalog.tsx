...
interface OnSaleCatalogProps {
  products: Product[];
}

export default function OnSaleCatalog({ products }: OnSaleCatalogProps) {
  ...
  if (products.length === 0) {
    return (
      <p className="text-center text-lg text-gray-600">
        No sale products found. Check back soon!
      </p>
    );
  }
  ...
  return (
    <>
      ...
      {filtered.length === 0 ? (
        <p className="text-center text-lg text-gray-600">
          No sale products in this category.
        </p>
      ) : (
